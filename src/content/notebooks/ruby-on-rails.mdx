...
<figure>
  <img
    src="https://cdn.midjourney.com/2eb7733b-6ed8-4820-aa43-75a7efe50c1e/0_2.png"
    alt="thoughts"
    class="w-full rounded-xl border-2 border-white shadow-xl"
    draggable="false"
  />
  <figcaption class="not-prose pt-4 [&>p]:not-italic [&>p]:my-0 [&>p]:!text-sm">
    Laying down the garden for my future self.
  </figcaption>
</figure>
